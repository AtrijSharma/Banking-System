...
public class refresh extends JFrame {
	...
	public refresh() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(refresh.class.getResource("/images/icons8-museum-16.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(refresh.class.getResource("/images/unnamed.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(refresh.class.getResource("/images/loader.gif")));
		
		JLabel lblNewLabel_3 = new JLabel("This is verified as a secure and trusted site.");
