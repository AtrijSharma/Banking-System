...
public class account extends JFrame {
	...
	public account() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(account.class.getResource("/images/icons8-museum-16.png")));
		setAlwaysOnTop(true);
		setResizable(false);
		...
		label.setIcon(new ImageIcon(account.class.getResource("/images/unnamed.png")));
		...
		btnNewButton.setIcon(new ImageIcon(account.class.getResource("/images/icons8-add-user-male-16.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(account.class.getResource("/images/icons8-delete-16.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(account.class.getResource("/images/icons8-go-back-16.png")));
		...
		JLabel lblNewLabel_6 = new JLabel("Copyrights(c)");
